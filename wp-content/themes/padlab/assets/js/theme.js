    ...
    if ($('.search-bar-wrap').length) {
        $(window).on('scroll', function () {
            ...
            if ($(this).scrollTop() > 1) {
                ...
                $('.search-bar-wrap').addClass('sticky-search-scrolled');
                $('header').css('display', 'none');
            } else {
                $('.search-bar-wrap').removeClass('sticky-search-scrolled');
...
// MAIN SEARCH BAR FILTERS 
    ...
    $('.search-grid-view').on('click', function () {
        ...
        $('div.search-listing-list-view').removeClass('active-listing');
        $('div.search-listing-grid-view').addClass('active-listing');
    });

    // List view (1/2 tiles, 1/2 map)
    $('.search-list-view').on('click', function () {
        $('div.search-listing-grid-view').removeClass('active-listing');
        $('div.search-listing-list-view').addClass('active-listing');
    });
//
//    // Full map view

...
<section>
    <div class="hero" style="background-image: url(<?php the_field('agent_hero'); ?>)">
...
<section class="agent-contact">
    <div class="agent-contact-btn agent-phone serif-2"><a href="tel:<?php the_field('agent_phone'); ?>"><?php the_field('agent_phone'); ?></a></div>
    <div class="agent-contact-btn agent-email serif"><?php the_field('agent_email'); ?></div>
</section>
...
<section class="agent-info-wrap">
    <div class="agent-images">
        <div class="agent-main-image">
            ...
            <div class="flexslider">
                <ul class="slides">
                    <li data-thumb="<?php the_field('agent_image'); ?>">
                        <div class="ratio-1-1">
                            <div class="ratio-sub-wrap">
                                <img src="<?php the_field('agent_image'); ?>" class="flexslider-img">
                            </div>
                        </div>
                    </li>
    ...
    <div class="agent-bio">
        <div class="agent-bio-wrap">
            <h2><?php the_title(); ?></h2>
            <h3><?php the_field('agent_title'); ?></h3>
            <p><?php the_field('agent_bio'); ?></p>
            <span></span>
        </div>
        ...
        <div class="agent-social-links">
            ...
            <ul class="single-social-links">
                <li class="single-social-link social-link-right-border"><a href="<?php the_field('agent_facebook'); ?>"><i class="fa fa-facebook-square"></i></a></li>
...
<section class="row mw-1040 agent-listings">
    ...
    <div class="agent-current">
        <?php
        if (get_field('agent_listings')) {
            echo the_field('agent_listings');
        } else {
